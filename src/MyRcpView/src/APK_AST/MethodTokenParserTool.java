...
public class MethodTokenParserTool {
            ...
            if (token.getType() <= lexer.WHILE) {
                if (!ArrayUtils.contains(reservedType, token.getType())) {
                    ...
                    if (index != -1)
                        ...
                        System.out.println("ReservedWord::"+tokenVector.TokenName);
                        ASTParserTool.method_key_word.add(tokenVector.TokenName);
                    }
                }
            }
        }
...
//                    System.out.println("Operator::"+tokenVector.TokenName);
                }
            }
        }
...
//                    System.out.println("Marker::"+tokenVector.TokenName);
                }
            }
        }
